    ...
    def msr_lin_steps(settle_time=5, sample_qty=1):
        ...
        for index, lin_step in enumerate(steps_list):
            ...
            while loop_step:
                ...
                avg_msmt, stdev = sample_power_meter(sample_qty_current)
                ...
                unc_2s_mW = calc_uncertainty(lin_step_mW, type_a_percent, sample_qty_current, attenuator_unc_pct=att_unc_percent,
...
def exercise_step_att_all(exercise_qty=3):
    printLog("\nExercising Step Attenuators...\n", console=True)
    for qty in range(1,exercise_qty):
        for i in range(0, 121):
            time.sleep(0.01)
            response = step_att_driver(attenuator_resource, i)

def exercise_step_att_step(desired_step, exercise_qty = 10):
