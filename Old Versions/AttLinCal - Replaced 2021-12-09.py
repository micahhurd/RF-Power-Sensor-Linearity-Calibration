...
def perform_lin_msmt(steps_list, tol_list, ref_pow, sample_qty):
    def dut_bias_msmt(sample_qty, reference_pow_setting, gen_pow_level, msmt_interval=1, settle_time=10):
        ...
        log.info(f'final bias_msmt value: {avg_msmt}, bias_stdev: {stdev}')
        ...
        for index, lin_step in enumerate(steps_list):
            ...
            while loop_step:
                ...
                if loop_step_cntr > 1:
                    ...
                    time.sleep(settle_time)
                    avg_msmt, stdev = sample_power_meter(3)
    ...
    bias_msmt, bias_stdev = dut_bias_msmt(biasMsmtQty, true_att, gen_level_pow_for_lin_msmt)
...
def exercise_step_att_step(desired_step, exercise_qty=10, interval=0.1):
