...
def perform_lin_msmt(steps_list, tol_list, ref_pow, sample_qty):
    ...
    def msr_lin_steps(settle_time=5, sample_qty=1):
        ...
        for index, lin_step in enumerate(steps_list):
            ...
            while loop_step:
                ...
                avg_msmt, stdev = sample_power_meter(sample_qty_current, interval=sampling_intv)
    ...
    bias_msmt, bias_stdev = dut_bias_msmt(biasMsmtQty, true_att, gen_level_pow_for_lin_msmt, msmt_interval=sampling_intv)
