...
def sample_power_meter_avg_of_avgs(sample_qty, meter_unit, lin_step, interval=1, qty_of_msmt_runs = 10):
    ...
    def msr_lin_steps(settle_time=5, sample_qty=1):
        ...
        for index, lin_step in enumerate(steps_list):
            ...
            while loop_step:
                ...
                if last_tur < 2:
                    qty_of_avgs = 6
                    avg_msmt, stdev_pct = sample_power_meter_avg_of_avgs(sample_qty_current, meter_unit, lin_step, interval=sampling_intv, qty_of_msmt_runs=qty_of_avgs)
                ...
                if avg_of_avgs_method == True:
                    sample_qty_current = qty_of_avgs        # Update sampling quantity to reflect the number of averaged measurements that were performed
